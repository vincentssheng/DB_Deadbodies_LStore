...
"""
# TESTING CODE TO MAKE SURE SUM WORKS
query.insert(123456789, 100, 90, 75, 80)
keys.append(123456789)
query.insert(987654321, 50, 60, 70, 80)
keys.append(987654321)
query.insert(135792468, 25, 30, 65, 80)
keys.append(135792468)
print(query.sum(123456789, 135792468, 1))
# should print 175
"""
